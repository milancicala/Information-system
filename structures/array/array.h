...
namespace structures 
{
	...
	{
		// 1. ako daleko mam skocit mapFunction
		// 2. spristupnit ukazovatel getBytePointer ... vrati *byte
		// 3. prekastovat (cast) na ukazovatel T
		// 4. return dereferenciu
	...
	inline int Array<T>::mapFunction(const int index) const
	{
		...
		return index * sizeof(T);	// polozky vectora maju velkost jedneho bajtu
	}
}
